...
<img src="./app.png" title="OpenAI Fullstack LangGraph" alt="OpenAI Fullstack LangGraph" width="90%">
...
-   **`TAVILY_API_KEY`**: The backend agent requires a Tavily API key for web search functionality.
...
2.  **Web Research:** For each query, it uses the Tavily Search API to find relevant web pages and then synthesizes the results using OpenAI models.
...
- [OpenAI](https://openai.com/) - LLM for query generation, reflection, and answer synthesis.
- [Tavily](https://tavily.com/) - Web search API for gathering information from the internet.
